    ...
    <div class="form-group">
        <fieldset>
            ...
            <div>
                ...
                $sltcat = "SELECT DISTINCT cat_nom, pro_cat_id FROM categories JOIN produits ON pro_cat_id=cat_id";
            ...
            <div>
                ...
                <input type="text" id="pro_libelle" name="pro_libelle">
            </div>
            <br>
            <div>
            ...
            <div>
                ...
                <input type="number" id="prix" name="pro_prix" min="0" max="9999.99" step="0.01">
            </div>
            <br>
            <div>
                <label for="pro_stock">Stock :</label>
                <input type="number" id="pro_stock" name="pro_stock" min="0" max="9999.99" step="any">
            </div>
            <br>
            <div>
            ...
            <div>
                ...
                <input type="date" id="pro_d_ajout" name="pro_d_ajout">
            </div>
            <br>
            <div>
        ...
        <div>
            ...
            <button type="reset" id="cancel" name="cancel" class="btn btn-warning">Effacer</button>
        </div>
</form><br>
</div>
</div>
